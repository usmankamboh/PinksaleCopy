...
import "IBEP20 code/IPinkAntiBot.sol";
import "IBEP20 code/BaseToken.sol";
abstract contract LaunchpadILO is IBEP20, Ownable, BaseToken {
    ...
    constructor(
        ...
        emit TokenCreated(owner(),address(this),TokenType.antiBotLiquidityGenerator,VERSION);
    ...
    function _getValues(uint256 tAmount)private view returns (uint256,uint256,uint256,uint256,uint256,uint256,uint256){
        ...
        (uint256 rAmount, uint256 rTransferAmount, uint256 rFee) = _getRValues(
            tAmount,tFee,tLiquidity,tCharity,_getRate());
    ...
    function _getRValues(uint256 tAmount,uint256 tFee,uint256 tLiquidity,uint256 tCharity,uint256 currentRate)
    ...
    function _transfer(address from,address to,uint256 amount) private {
        ...
        bool takeFee = false;
        //take fee only on swaps, only excluded list, or transfer from uniswapV2Pair address.
