...
import "IBEP20 code/IUniswapV2Factory.sol";
    ...
    abstract contract launchpad is Context, IBEP20, Ownable {
    ...
    string private _symbol = "DUCK20210703";
    ...
    address public devWallet = 0x0736394c0Ca4780C7a3A0BBadFf5557077ae5690;   // TODO: Change to the address which you use for deployment
    ...
    constructor ()  {
        ...
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0xD99D1c33F9fC3444f8101754aBC46c52416550D1); //TODO: change to routerV2
